...
import { get_Products_Buy } from "@/graphql/queries"
...
const Buy = () => {
  const { data, loading, error, refetch } = useQuery(get_Products_Buy)
  console.log("data ========== ",error)
  const All_Products_Buy = data?.getProduct_Buy
  ...
  useEffect(() => {
    if (All_Products_Buy) {
      setFilteredProducts(All_Products_Buy)
  ...
  useEffect(() => {
    if (All_Products_Buy) {
      const filtered = All_Products_Buy.filter(
        (product) =>
